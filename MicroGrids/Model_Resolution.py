...
def Model_Resolution(model,Renewable_Penetration, Battery_Independency,datapath="Example/data.dat"):   
    ...
    from Constraints import  Net_Present_Cost, Renewable_Energy,State_of_Charge,Deferable_Energy_Constraint,Deferable_Power_Max,\
    ...
    model.BatteryRepositionCost = Constraint(model.scenario,
                                             rule=Battery_Reposition_Cost) 
    # deferable demand constraints
    
    model.DeferableEnergyConstraint = Constraint(model.scenario,
                                                 model.deferable_time_set,
                                                 rule=Deferable_Energy_Constraint)
    model.DeferablePowerMax = Constraint(model.scenario, model.periods,
